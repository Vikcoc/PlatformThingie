...
namespace AuthFrontend.Tests
{
    public abstract class JwtLoginServiceTests(IJwtLogValidatorService logInService)
    {
        ...
        [Fact]
        public async Task ValidateToken_BadSignatureAndExpired_ReturnInvalid()
        {
            var result = await _logInService.ValidateToken("eyJhbGciOiJSUzI1NiIsImtpZCI6Ijc2YTI2OTMwNGMzZTkxMjUwYzlhMzM5MzJjYjIyIiwidHlwIjoiSldUIn0.eyJuYmYiOjE3MDk3MjcyOTMsImV4cCI6MTcwOTczMDg5MywiaWF0IjoxNzA5NzI3MjkzLCJpc3MiOiJtZSIsImF1ZCI6Im1lIn0.MXmjoe2pXQ6jfcmnEF2kAajfpcWGtzlrCRKsUDF2EwALzwR_pbcgTmG3c4-firRbrbiWTH3psnis2HDvViQzPsNAlejM_xR-cs21TuFoFYetDTx0SOJcmCd4OQKWPLP7co9l6eE-s7I3zpJiQEFy3TXnfZznc3HWc1G5J6wefFU");

            Assert.Null(result);
        }

        [Fact]
        public async Task ValidateToken_ValidToken_ReturnValid()
        {
            var result = await _logInService.ValidateToken(Token);
        ...
        protected static string Token
        {
            get
            {
                ...
                static string MakeTokin()
                {
                    ...
                    {
                        KeyId = "76a269304c3e91250c9a33932cb22"
                    };
                    ...
                    var desc = new SecurityTokenDescriptor()
                    {
                        ...
                        Audience = "me",
                        Issuer = "me",
                        Claims = new Dictionary<string, object>() { { "email", "me@me.me" }, { "name", "Meme" }, { "username", "stillme" }, { ImportantStrings.Purpose, ImportantStrings.Refresh }, { "jti", Guid.NewGuid().ToString() } }
