...
string MakeTokin()
{
    ...
    var desc = new SecurityTokenDescriptor() 
    {
        ...
        //AdditionalInnerHeaderClaims = new Dictionary<string, object>() { { "kid", "1234" } },
        
    };
    var a = desc.SigningCredentials.Kid;
    //desc.AdditionalHeaderClaims.Add("kid", "1234");
